...
<html lang="en">
    <head>
        ...
        <title>Toilet Light Settings</title>
        <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.12.4/jquery.min.js"></script>
        <link href="https://fonts.googleapis.com/css?family=Montserrat" rel="stylesheet">
        <link rel="stylesheet" href="css/toiletform.css" >
		<!-- Bootstrap core CSS -->
    ...
    <link href="Conditions/lightsetting/css/toilettest.css" rel="stylesheet">
    ...
    <body>
      ...
      <div class="container">
        ...
        <div class="container">
            <div id="form-main">
                <div id="form-div">
                    <form name="myForm" method="post" action="toiletlightconnect.php" onsubmit="return checkInp()" class="montform" id="reused_form" >
