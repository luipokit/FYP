...
<html lang="en">
    <head>
        ...
        <title>Living Room Light Settings</title>
        <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.12.4/jquery.min.js"></script>
        <link href="https://fonts.googleapis.com/css?family=Montserrat" rel="stylesheet">
        <link rel="stylesheet" href="css/livingroomform1.css" >
		<!-- Bootstrap core CSS -->
    ...
    <link href="Conditions/lightsetting/css/livingroomtest.css" rel="stylesheet">
    ...
    <body>
      ...
      <div class="container">
        ...
        <div class="container">
            <div id="form-main">
                <div id="form-div">
                    <form name="myForm" method="post" action="livingroomlightconnect.php" onsubmit="return checkInp()" class="montform" id="reused_form" >
